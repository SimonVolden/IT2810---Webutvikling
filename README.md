...
Merk: Det er ikke nødvendig å kjøre backend, da denne kjører på VM.
...
# Introduksjon
Prosjektet er i stor grad likt fra prosjekt 4, de største forskjellene gjelder Universell utforming, som vi har skrevet om under. Ellers har vi endret plasseringer på filer mellom mappene "components" og "pages" slik at de blir representert bedre. 

Beer Viewer er en interaktiv webapplikasjon som lar brukeren lete etter ulike øltyper. Applikasjonen laster inn data fra en Mongodb database. Databasen aksesseres fra backend med MongoClient. Backend er en Apollo Server som kjører kall med GraphQL.
