...
// node_modules\.bin\cypress open
  ...
  describe('End To End test', () => {
    ...
    it("Test Logout and making new user with used email", () =>{
        ...
        .should("deep.equal", {  theme: false,pageNumber: 1, search: "", field: "id", order: 1, signup: true, textSize: 14})
    ...
    it("Test Theme Toggle", ()=> {
        ...
        // check both states.
        cy.window().its('store').invoke('getState')
            .should("deep.equal", {  theme: false,pageNumber: 1, search: "", field: "id", order: 1, signup: false, textSize: 14 })
        cy.get("[id=themeToggle]").click()
        cy.window().its('store').invoke('getState')
            .should("deep.equal", {  theme: true,pageNumber: 1, search: "", field: "id", order: 1, signup: false, textSize: 14 })
        cy.get("[id=themeToggle]").click()    
        cy.window().its('store').invoke('getState')
            .should("deep.equal", {  theme: false,pageNumber: 1, search: "", field: "id", order: 1, signup: false, textSize: 14 })
        })
    ...
    it("Test Page Number Counter", () => {
        ...
        cy.window().its('store').invoke('getState')
            .should("deep.equal", {  theme: false,pageNumber: 2, search: "", field: "id", order: 1, signup: false, textSize: 14 })
        ...
        cy.window().its('store').invoke('getState')
            .should("deep.equal", {  theme: false,pageNumber: 23, search: "", field: "id", order: 1, signup: false, textSize: 14 })
        cy.get("[id=incPageNumber]").click()
        cy.window().its('store').invoke('getState')
            .should("deep.equal", {  theme: false,pageNumber: 24, search: "", field: "id", order: 1, signup: false, textSize: 14 })
        cy.get("[id=incPageNumber]").click()
        cy.window().its('store').invoke('getState')
            .should("deep.equal", {  theme: false,pageNumber: 24, search: "", field: "id", order: 1, signup: false, textSize: 14 })
        cy.get("[id=inputPageNumber]").click().type('{selectall}10')
        cy.window().its('store').invoke('getState')
            .should("deep.equal", {  theme: false,pageNumber: 10, search: "", field: "id", order: 1, signup: false, textSize: 14 })
    ...
    it("Test Change of sorting by name", () =>{
        ...
        cy.window().its('store').invoke('getState')
            .should("deep.equal", {  theme: false,pageNumber: 1, search: "", field: "name", order: 1, signup: false, textSize: 14 })
    ...
    it("Test Change of sorting by Alcohol precentage", () => {
        ...
        cy.window().its('store').invoke('getState')
            .should("deep.equal", {  theme: false,pageNumber: 1, search: "", field: "abv", order: 1, signup: false, textSize: 14 })
        cy.findByText("Buzz").should("not.exist")
    ...
    it("Test Change of sorting by Likes", ()=> {
        ...
        cy.window().its('store').invoke('getState')
            .should("deep.equal", {  theme: false,pageNumber: 1, search: "", field: "likes", order: 1, signup: false, textSize: 14 })
        cy.findByText("Buzz").should("not.exist")
